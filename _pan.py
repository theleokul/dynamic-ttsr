...
class PAN(nn.Module):
    ...
    def __init__(self, in_nc, out_nc, nf, unf, nb, scale=2):
        ...
        ### main blocks
        self.SCPA_trunk = utils.make_layer(SCPA_block_f, nb)
    ...
    def forward(self, x):
        ...
        # skip connection after all SCPA blocks (not presented in original paper)
        fea = fea + trunk
        ...
        # Global skip through the whole model
