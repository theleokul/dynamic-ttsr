...
class MainNet(nn.Module):
    def __init__(self, num_res_blocks, n_feats, res_scale):
        ...
        ### stage11
        self.cca11_head = CCALayer(256+n_feats, reduction=16)
        ...
        self.cca22_head = CCALayer(128+n_feats, reduction=16)
        ...
        self.cca33_head = CCALayer(64+n_feats, reduction=16)
    ...
    def forward(self, x, S=None, T_lv3=None, T_lv2=None, T_lv1=None):
        ...
        x11_res = self.cca11_head(x11_res)
        ...
        x22_res = self.cca22_head(x22_res)
        ...
        x33_res = self.cca33_head(x33_res)
