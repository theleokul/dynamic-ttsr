...
class MainNet(nn.Module):
    def __init__(self, num_res_blocks, n_feats, res_scale):
        ...
        for i in range(self.num_res_blocks[1]):
            self.RB11.append(ResBlock(n_feats, n_feats, scaling='11'))
        ...
        for i in range(self.num_res_blocks[2]):
            self.RB21.append(ResBlock(n_feats, n_feats, scaling='21'))
            self.RB22.append(ResBlock(n_feats, n_feats, scaling='22'))
        ...
        for i in range(self.num_res_blocks[3]):
            self.RB31.append(ResBlock(n_feats, n_feats, scaling='31'))
            self.RB32.append(ResBlock(n_feats, n_feats, scaling='32'))
            self.RB33.append(ResBlock(n_feats, n_feats, scaling='33'))
    ...
    def forward(self, x, S=None, T_lv3=None, T_lv2=None, T_lv1=None, meta=None):
        ...
        for i in range(self.num_res_blocks[1]):
            x11_res, meta = self.RB11[i]([x11_res, meta])
        ...
        for i in range(self.num_res_blocks[2]):
            x21_res, meta = self.RB21[i]([x21_res, meta])
            x22_res, meta = self.RB22[i]([x22_res, meta])
        ...
        for i in range(self.num_res_blocks[3]):
            x31_res, meta = self.RB31[i]([x31_res, meta])
            x32_res, meta = self.RB32[i]([x32_res, meta])
            x33_res, meta = self.RB33[i]([x33_res, meta])
